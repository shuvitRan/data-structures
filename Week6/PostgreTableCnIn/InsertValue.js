...
var fs=require('fs');
var content = fs.readFileSync("data/M07CleanData.json");
...
async.eachSeries(addressesForDb, function(value, callback) {
    ...
    client.connect();
      ...
      // var thisQuery = "INSERT INTO aainfo ( mtdate,mtstart, mtend, mttype, mtspin, mtzone ) VALUES ('{"+value.mtDate+"}','{"+ value.start+"}','{"+ value.end + "}','{"+ value.type+ "}','{"+ value.spinterest+"}',"+ value.zone+ ");";
